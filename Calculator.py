...
tk.title('Calculator by Tech Coding')
tk.geometry('280x200')
...
clear_button = Button(tk, text='Clear', fg='black', bg='#8f8f8f', command=clear_input, height=2, width=7)
clear_button.grid(row=5, column=1)

tk.bind("<Key>", keyboard_press)
